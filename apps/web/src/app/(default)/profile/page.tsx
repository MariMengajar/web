            ...
            <div className='relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-slate-200 border-0'>
              <div className='rounded-t mb-0 px-6 py-6 space-y-6'>
                ...
                <form onSubmit={handleSubmit}>
                  <label htmlFor="verificationFile" className="font-bold">Verification Status</label>
                  <input type="file" name="verificationFile" id="verificationFile" />
                  <input type="submit" value="Submit" className='bg-white active:bg-slate-50 text-slate-700 px-4 py-2 rounded outline-none focus:outline-none mr-1 mb-1 uppercase shadow hover:shadow-md inline-flex items-center font-bold text-xs ease-linear transition-all duration-150 mx-auto' />
                </form>
              </div>
            </div>
          </div>
